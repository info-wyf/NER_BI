...
class Model(object):
    def __init__(self, config, is_train=True):
        ...
        self.embedding_dim = self.lstm_dim+self.lstm_dim
        self.repeat_times = 4
        ...
        if self.model_type == 'BI':
            ...
            # [20,21,200]                       [20,21,120]             100             [20]
            model_outputs_bilstm = self.biLSTM_layer(model_inputs, self.lstm_dim, self.lengths)

            # ldcnn layer
            # [20,21,400]                           [20,21,200]
            model_outputs = self.IDCNN_layer(model_outputs_bilstm)
